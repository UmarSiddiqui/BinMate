...
> This file is read automatically by Claude Code, Cursor, and Codex at session start.
...
When switching between Claude Code → Cursor → Codex, always leave a `HANDOFF.md` in the repo root with:
