...
enum BinMateTheme {
    ...
    enum Symbols {
        // Keep names iOS 16-safe for consistent rendering across supported devices.
        static let bins         = "trash.fill"
        ...
        static let binsOut      = "bell.badge.fill"
        static let garden       = "leaf.fill"
        static let recycling    = "recycle"
        static let verge        = "shippingbox"        // Bulk / verge collection
